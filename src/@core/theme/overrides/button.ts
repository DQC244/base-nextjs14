  ...
  MuiButton: {
    styleOverrides: {
        ...
        ...(ownerState.variant === "text"
          ...
          : {
              ...(ownerState.variant === "outlined"
                ? {
                    ...(ownerState.size === "small" && {
                      padding: theme.spacing(1.75 / 2, 3.25 / 2),
                    }),
                    ...(ownerState.size === "medium" && {
                      padding: theme.spacing(1.75 / 2, 4.25 / 2),
                    }),
                    ...(ownerState.size === "large" && {
                      padding: theme.spacing(1.75 / 2, 5.25 / 2),
                    }),
                  }
                : {
                    ...(ownerState.size === "small" && {
      ...
      startIcon: ({ theme, ownerState }) => ({
        ...(ownerState.size === "small"
          ? {
              marginInlineEnd: theme.spacing(1.5 / 2),
            }
          : {
              ...(ownerState.size === "medium"
                ? {
                    marginInlineEnd: theme.spacing(2 / 2),
                  }
                : {
                    marginInlineEnd: theme.spacing(2.5 / 2),
                  }),
            }),
      ...
      endIcon: ({ theme, ownerState }) => ({
        ...(ownerState.size === "small"
          ? {
              marginInlineStart: theme.spacing(1.5 / 2),
            }
          : {
              ...(ownerState.size === "medium"
                ? {
                ...
                : {
                    marginInlineStart: theme.spacing(2.5 / 2),
                  }),
            }),
        ...iconStyles(ownerState.size),
      }),
