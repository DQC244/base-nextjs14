...
import { CircularIcon } from "@components/icons";
...
const MenuItem: ForwardRefRenderFunction<HTMLLIElement, MenuItemProps> = (
  ...
  const { toggleVerticalNav, isToggled, isBreakpointReached } =
    useVerticalNav();
  ...
  return (
    ...
    >
      <MenuButton
        className={clsx(menuClasses.button, { [menuClasses.active]: active })}
